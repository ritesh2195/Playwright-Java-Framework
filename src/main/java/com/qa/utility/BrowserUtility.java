...
public class BrowserUtility {
    ...
    public Page initBrowser() {
        ...
        String browserName = ConfigReaderUtility.getInstance().getBrowser();
        ...
        getPage().navigate(ConfigReaderUtility.getInstance().getURL());

        getPage().waitForURL(ConfigReaderUtility.getInstance().getURL());
